...
class CheckoutAddressCds extends React.PureComponent {
  static propTypes = {
    address: pt.object,
    className: pt.string,
  };
  ...
  renderAddress = () => {
    ...
    const flattenAddress = explode(address) || {};
    const {
      address_line,
      address_name,
      building,
    ...
    const regionValue = get(region, 'region', '');
...
export default withStyles(s)(CheckoutAddressCds);
